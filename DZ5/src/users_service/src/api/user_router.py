...
user_service = UserService(controller=UserController())
...
async def search_users(name: Optional[str] = Query(default=None), session: AsyncSession = Depends(get_session),):
    """
